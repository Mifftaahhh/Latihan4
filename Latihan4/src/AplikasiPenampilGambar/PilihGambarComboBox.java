...
public class PilihGambarComboBox extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        pCardLayout.add(lblApex, "1");

        pilihan.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "- Select -", "APEX LEGENDS", "PUBG : BATTLEGROUNDS", "COUNTER STRIKE 2" }));
